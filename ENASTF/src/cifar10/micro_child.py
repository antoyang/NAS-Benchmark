...
sys.path.insert(0, '/cache/ENASTF') #Path to your code repository
...
class MicroChild(Model):
  ...
  def _model(self, images, classes, is_training, reuse=False):
        ...
        if (self.use_aux_heads and
          ...
          with tf.variable_scope("aux_head"):
            ...
            with tf.variable_scope("fc"):
              ...
              w = create_weight("w", [inp_c, classes])
  ...
  def _build_train(self):
    ...
    logits = self._model(self.x_train, self.classes, is_training=True)
    #print("logits:")
    #print(logits)
  ...
  def _build_valid(self):
    if self.x_valid is not None:
      ...
      logits = self._model(self.x_valid, self.classes, False, reuse=True)
  ...
  def _build_test(self):
    ...
    logits = self._model(self.x_test, self.classes, False, reuse=True)
  ...
  def build_valid_rl(self, shuffle=False):
    ...
    logits = self._model(x_valid_shuffle, self.classes, is_training=True, reuse=True)
