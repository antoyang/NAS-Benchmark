...
parser.add_argument('--n_gens', type=int, default=50, help='population size') #should have been set to 20
...
class NAS(Problem):
    ...
    def __init__(self, search_space='micro', n_var=20, n_obj=1, n_constr=0, lb=None, ub=None,
                 init_channels=24, layers=8, epochs=25, save_dir=None, data_path="../data",dataset="CIFAR10"):
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        for i in range(x.shape[0]):
            ...
            performance = train_search.main(genome=genome,
                                            ...
                                            expr_root=self._save_dir,data_path=self.data_path, dataset=self.dataset)
...
def main():
    ...
    problem = NAS(n_var=n_var, search_space=args.search_space,
                  ...
                  epochs=args.epochs, save_dir=args.save,data_path=args.data_path,dataset=args.dataset)
