...
class SearchCNN(nn.Module):
    """ Search CNN model """
    def __init__(self, C_in, C, n_classes, n_layers, n_nodes=4, stem_multiplier=3, imagenet_mode=False):
        """
        Args:
...
class SearchCNNController(nn.Module):
    ...
    def __init__(self, C_in, C, n_classes, n_layers, criterion, n_nodes=4, stem_multiplier=3,
                 device_ids=None, imagenet_mode=False):
        super().__init__()
        ...
        self.net = SearchCNN(C_in, C, n_classes, n_layers, n_nodes, stem_multiplier, imagenet_mode=imagenet_mode)
    ...
    def genotypetoaugment(self, layers_augment=20):
        ...
        genotype["normal_concat"] = range(2, 2 + self.n_nodes)  # concat all intermediate nodes
        genotype["reduce_concat"] = range(2, 2 + self.n_nodes)  # concat all intermediate nodes
