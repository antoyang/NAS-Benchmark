...
class AugmentConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--lr_min', type=float, default=1e-8, help='lr for weights')
        ...
        parser.add_argument('--p', type=int, default=1, help="1 for cosine annealing lr, 2 for cosine power annealing")
